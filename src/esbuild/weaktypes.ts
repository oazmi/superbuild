...
import type { AutoSuggestOrString, MaybePromise } from "../deps.ts"
import type { EsbuildBuildOptions, EsbuildBuildResult, EsbuildLoaderType, EsbuildMessage, EsbuildPluginBuild, OnLoadResult, SameShape } from "./strongtypes.ts"
